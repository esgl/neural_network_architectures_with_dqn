...
def _cnn_to_lstm_new(convs, lstm_hidden_size, lstm_out_size, hiddens, batch_size, duelings,
...
def cnn_to_lstm_new(convs, lstm_hidden_size, lstm_out_size, hiddens, batch_size, duelings=False, layer_norm=False):
    return lambda *args, **kwargs: _cnn_to_lstm_new(
        convs,
        lstm_hidden_size,
        lstm_out_size,
        hiddens,
